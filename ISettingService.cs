...
namespace EskaCMS.Core.Services
{
    ...
    public interface ISettingService
    {
        ...
        Task<string> GetSettingValueAsync(string name,long SiteId);
        ...
        Task<Dictionary<string, string>> GetAllSettingsAsync(long SiteId);
        ...
        /// <returns></returns>
        Task UpdateSettingAsync(string name, string value,long SiteId);
        ...
        Task<string> GetShipmentStatus(string trackingNo);
    }
}
